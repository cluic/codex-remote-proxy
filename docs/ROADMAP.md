...
M2: V1 implementation, with Tasks 1 through 10 landed and the actual Web UI assets next.
...
| V1: Provider lifecycle end to end | Add, test, activate, switch, and restart through local UI without changing Codex provider | In progress: Tasks 1-10 complete; Web UI and acceptance remain | Full acceptance flow in `docs/TESTING.md` |
...
4. Next: onboarding and guided utility Web UI assets.
