...
function MetricCard({
  ...
  return (
    <article className="metric-card min-w-0 rounded-xl border border-border bg-card p-4 shadow-sm">
...
function TokenHeatmapPanel({
  ...
  return (
    <Panel className="overview-trend-panel min-w-0 overflow-hidden">
      <header className="overview-panel-header flex items-start justify-between gap-4 border-b border-border px-4 py-3">
        <div>
...
export function OverviewPage({
  ...
  return (
    <div className="page-stack overview-page space-y-4" data-testid="page-overview">
      {!ready ? (
        <section className="overview-action-strip flex flex-wrap items-center justify-between gap-4 rounded-xl border border-border bg-card px-4 py-3" aria-labelledby="overview-action-title">
      ...
      <section className="overview-command-bar grid min-w-0 overflow-hidden rounded-xl border border-border bg-card shadow-sm lg:grid-cols-[1.05fr_1.15fr_1.8fr]" aria-label={t("system.accountTitle")}>
        <div className="overview-account-segment flex min-w-0 items-center gap-3 p-4">
        ...
        <label className="overview-routing-segment grid min-w-0 cursor-pointer items-center gap-3 border-t border-border p-4 lg:border-t-0 lg:border-l">
          <input
            type="checkbox"
        ...
        <div className="overview-quota-segment flex min-w-0 items-center gap-3 border-t border-border p-4 lg:border-t-0 lg:border-l">
      ...
      <section className="metrics-section overview-metrics" aria-labelledby="metrics-heading">
        <header className="overview-metrics-toolbar flex flex-wrap items-center justify-between gap-4">
          <div>
        ...
        {metricsUnavailable ? (
          ...
          <>
            ...
            <div className="metric-grid grid min-w-0 gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <MetricCard
            ...
            {metrics.summary.requests === 0 && !heatmapHasTraffic && !heatmapHasIssue ? (
              ...
              <div className="overview-dashboard grid min-w-0 gap-4" data-testid="metrics-loaded">
                <TokenHeatmapPanel heatmap={heatmap} error={heatmapError} locale={locale} t={t} />

                {metrics.summary.requests > 0 ? <div className="overview-summary-grid grid min-w-0 items-start gap-4 xl:grid-cols-[minmax(0,.9fr)_minmax(0,1.1fr)]">
                  <Panel className="overview-summary-panel overview-model-summary min-w-0 overflow-hidden">
                            ...
                            <div className="overview-model-details">
                              ...
                              >
                                <rect
                                  ...
                                  width={model.requests > 0
                                    ? Math.max(2, Math.min(100, model.requests / maximumModelRequests * 100))
                                    : 0}
                                  height="4"
                                  rx="2"
                                />
                  ...
                  <Panel className="overview-summary-panel overview-provider-summary min-w-0 overflow-hidden">
                    <header className="overview-summary-heading">
                    ...
                    {metrics.providers.length > 0 || metrics.providerOtherRequests > 0 ? (
                      <div className="overview-provider-table-wrap overflow-x-auto">
                        <table className="overview-provider-table w-full border-collapse text-sm">
                          <caption className="visually-hidden">{t("overview.providerPerformance")}</caption>
                          <thead><tr>
