...
- The custom-only board renders at 1128 × 234 px. The collapsed account-first board renders at 1128 × 288 px and expands to 1128 × 354 px only on demand. The 390 px collapsed board renders at 358 × 413 px, keeps each active rail horizontal, removes redundant request/account nodes from the long custom-only rail, and passes clipping, overlap, and document-overflow checks.
